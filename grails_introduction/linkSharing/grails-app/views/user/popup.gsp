		...
		<div class="container">
           ...
           <div class="popup-container"><!-- Popup Contents, just modify with your own -->
               <g:form controller="user" action="createTopic" class="form-signin2popup" name="userForm">
                   ...
                   <g:select name="seriousness"  class="form-control" from="${com.ttnd.Subscription.SeriousnessValue}"/>
                   <g:select name="visibility" class="form-control" from="${com.ttnd.Topic.VisibilityEnum}"/>
