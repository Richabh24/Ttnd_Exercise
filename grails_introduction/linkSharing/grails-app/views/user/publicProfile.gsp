...
<div class="container">
    ...
    <div class="col-md-6 col-lg-6">
        <article class="tweet user">
            ...
            <div class="userImg">
                <img class="tweetImg" src="${createLink(controller: 'user', action:'displayLogo ', id:data.user?.id)}"/>
            </div>
                    </div>
                <div class="col-md-9 col-lg-9 ">
            <div class="userPost"  style="width: 245px">
    ...
    <div class="popup-wrapper popup-class" id="popup">
        <div class="popup-container"><!-- Popup Contents, just modify with your own -->
            <g:form controller="topic" action="createTopic" class="form-signin2popup" name="userForm">
                ...
                <br/> <g:select name="seriousness"  class="form-control" from="${com.ttnd.Subscription.SeriousnessValue}"/>
                <br/><g:select name="visibility" class="form-control" from="${com.ttnd.Topic.VisibilityEnum}"/>
    ...
    <div class="popup-wrapper popup-class" id="popup2">
        <div class="popup-container">
            <g:form controller="user" action="createTopic" class="form-signin2" name="userForm">
                <div class="myHeading2">
                ...
                <g:select name="topic" from="${data.subscriptions.name}" title="Select a Topic" class="form-control"/>
                <br/>
                <g:submitButton name="Invite" class="btn btn-lg btn-primary btn-block" type="submit" style="background-color: rgb(213, 162, 242)">Share</g:submitButton>
                <button name="Cancel" class="btn btn-lg btn-primary btn-block"  value="Cancel"  style="background-color: rgb(213, 162, 242)">Cancel</button>
            </g:form>
    ...
    <div class="popup-wrapper popup-class" id="popup3">
        <div class="popup-container">
            <g:uploadForm enctype="multipart/form-data" controller="user" action="createDocResource" class="form-signin2" name="userForm">
                <div class="myHeading2">
    ...
    <div class="popup-wrapper popup-class" id="popup4">
        <div class="popup-container">
            <g:form controller="user" action="createLinkResource" class="form-signin2" name="userForm">
                <div class="myHeading2">
                    <h2>Share Link</h2>
                </div>
                <br/>
