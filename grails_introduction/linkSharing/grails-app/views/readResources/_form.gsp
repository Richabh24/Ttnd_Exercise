...
<div class="fieldcontain ${hasErrors(bean: readResourcesInstance, field: 'resource', 'error')} required">
	...
	<g:select id="resource" name="resource.id" from="${com.ttnd.Resource.list()}" optionKey="id" required="" value="${readResourcesInstance?.resource?.id}" class="many-to-one"/>
...
<div class="fieldcontain ${hasErrors(bean: readResourcesInstance, field: 'user', 'error')} required">
	...
	<g:select id="user" name="user.id" from="${com.ttnd.User.list()}" optionKey="id" required="" value="${readResourcesInstance?.user?.id}" class="many-to-one"/>
