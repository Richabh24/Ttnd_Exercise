...
<div class="fieldcontain ${hasErrors(bean: topicInstance, field: 'name', 'error')} required">
	...
	<g:textField name="name" maxlength="15" required="" value="${topicInstance?.name}"/>
...
<div class="fieldcontain ${hasErrors(bean: topicInstance, field: 'createdBy', 'error')} required">
	...
	<g:select id="createdBy" name="createdBy.id" from="${com.ttnd.User.list()}" optionKey="id" required="" value="${topicInstance?.createdBy?.id}" class="many-to-one"/>
...
<div class="fieldcontain ${hasErrors(bean: topicInstance, field: 'visibility', 'error')} required">
	...
	<g:select name="visibility" from="${com.ttnd.Topic$VisibilityValue?.values()}" keys="${com.ttnd.Topic$VisibilityValue.values()*.name()}" required="" value="${topicInstance?.visibility?.name()}" />
